...
Use this sequence to verify all 5 endpoints are working correctly after starting the server:
...
Expected: HTTP 400 — `{"detail": "Amount must be greater than 0"}`
...
| Version | Date       | Change                                              |
|---------|------------|-----------------------------------------------------|
| 1.0     | 2024–2025  | Initial release — 5 endpoints, in-memory storage   |
